<%-- 
    Document   : panelAgregarServicio
    Created on : 19 may. 2023, 07:21:15
    Author     : LENOVO
--%>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <table class="table table-bordered" width="100%" cellspacing="0">
                                <tr>
                                    <td>Nombre:<input class="form-control" type="text" name="nombre"></td>
                                    <td>Duracion:<input class="form-control" type="text" name="duracion"></td>
                                    <td>Precio:<input class="form-control" type="text" name="precio"></td>
                                    <td>Turno:<input class="form-control" type="text" name="turno"></td>
                                </tr>
                                <tr>
                                    <td>Nombre de la imagen:<input class="form-control" type="text" name="img"></td>
                                    <td><p>Tipo:</p>
                                            <select name="idtipo" class="form-control"> 
                                                <option value="grado" selected>Seleccione tipo de servicio</option>
                                    ...
                                    <td class="text-center"></br>
                                        <a class="btn btn-success btn-icon-split" type="submit" name="accion" value="Agregar">
                            ...
                            <p>Descripción</p>
                            <textarea class="form-control" name="descripcion" rows="5" cols="10"></textarea>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <th class="text-center">
                                                <a href="../Administracion/panelModCliente.jsp" class="btn btn-danger btn-icon-split">
                                                    <span class="icon text-white-50">
                                                        <i class="fas fa-trash"></i>
                                                    </span>
                                                </a>
                                                <a href="../Administracion/panelModCliente.jsp" class="btn btn-warning btn-icon-split">
                                                    <span class="icon text-white-50">
