<%-- 
    Document   : panelAgregarUsuario
    Created on : 19 may. 2023, 07:21:03
    Author     : LENOVO
--%>
                        ...
                        <div class="modal-body">
                            <table class="table table-bordered" width="100%" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td>Horario:<input class="form-control" type="text" name="horario"></td>
                                </tr>
                                <tr>
                                    <td><p>Rol:</p>
                                        <select name="rol" class="form-control"> 
                                            <option value="grado" selected>Seleccione rol</option>
                                    ...
                                    <td><p>Especialidad:</p>
                                        <select name="especialidad" class="form-control"> 
                                            <option value="grado" selected>Seleccione especialidad</option>
