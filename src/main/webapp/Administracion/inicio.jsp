                ...
                <div class="container-fluid">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Base Datos de Clientes</h6>
                                </div>
                                <div class="card-body">
                                                 ...
                                                 <%
                                                  ...
                                                  %>
                                                                 <tr class="grilla_campo"> 
                                                                        ...
                                                                        <td><%= cliente.getApePat() %></td>
                                                                        <td><%= cliente.getApeMat() %></td>                                                                        			
                                                                 </tr>
                                    ...
                                    <table class="table table-bordered" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>Tiger Nixon</td>
                                                <td>12345678</td>
                                                <td>anonimo@gmail.com</td>
                                                <td>Av. Ejercito N° 1200</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
