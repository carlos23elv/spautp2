<%-- 
    Document   : panelModServicio.jsp
    Created on : 19 may. 2023, 07:22:00
    Author     : LENOVO
--%>
                ...
                <div class="modal-body" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Modificar / Eliminar Servicio</h5>
                        </div>
                        <div class="modal-body">
                            <table class="table table-bordered" width="100%" cellspacing="0">
                                ...
                                <tr>
                                    <td><p>Nombre de la imagen:</p><input class="form-control" type="text" name="img"></td>
                                    <td><p>Tipo:</p>
