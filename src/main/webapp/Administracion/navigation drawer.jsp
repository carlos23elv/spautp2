<%-- 
    ...
    Created on : 19 may. 2023, 06:40:46
    Author     : LENOVO
--%>
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="panelAgregarCliente.html">Cliente</a>
                        <a class="collapse-item" href="panelAgregarUsuario.html">Usuario</a>
                        <a class="collapse-item" href="panelAgregarServicio.html">Servicio</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Elija opción:</h6>
                        <a class="collapse-item" href="panelModCliente.html">Cliente</a>
                        <a class="collapse-item" href="panelModUsuario.html">Usuario</a>
                        <a class="collapse-item" href="panelModServicio.html">Servicio</a>
                    </div>
                </div>
            </li>
